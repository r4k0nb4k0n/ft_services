...
then
	...
	influx -host 'localhost' -port '8086' -execute "CREATE USER ${INFLUXDB_ROOT_USERNAME} WITH PASSWORD '${INFLUXDB_ROOT_PASSWORD}' WITH ALL PRIVILEGES"
	influx -host 'localhost' -port '8086' -execute "CREATE USER ${INFLUXDB_FT_NGINX_USERNAME} WITH PASSWORD '${INFLUXDB_FT_NGINX_PASSWORD}' WITH ALL PRIVILEGES"
	influx -host 'localhost' -port '8086' -execute "CREATE USER ${INFLUXDB_FT_PHPMYADMIN_USERNAME} WITH PASSWORD '${INFLUXDB_FT_PHPMYADMIN_PASSWORD}' WITH ALL PRIVILEGES"
	influx -host 'localhost' -port '8086' -execute "CREATE USER ${INFLUXDB_FT_WORDPRESS_USERNAME} WITH PASSWORD '${INFLUXDB_FT_WORDPRESS_PASSWORD}' WITH ALL PRIVILEGES"
	influx -host 'localhost' -port '8086' -execute "CREATE USER ${INFLUXDB_FT_MYSQL_USERNAME} WITH PASSWORD '${INFLUXDB_FT_MYSQL_PASSWORD}' WITH ALL PRIVILEGES"
	influx -host 'localhost' -port '8086' -execute "CREATE USER ${INFLUXDB_FT_FTPS_USERNAME} WITH PASSWORD '${INFLUXDB_FT_FTPS_PASSWORD}' WITH ALL PRIVILEGES"
	influx -host 'localhost' -port '8086' -execute "CREATE USER ${INFLUXDB_FT_GRAFANA_USERNAME} WITH PASSWORD '${INFLUXDB_FT_GRAFANA_PASSWORD}' WITH ALL PRIVILEGES"
	influx -host 'localhost' -port '8086' -execute "CREATE USER ${INFLUXDB_FT_INFLUXDB_USERNAME} WITH PASSWORD '${INFLUXDB_FT_INFLUXDB_PASSWORD}' WITH ALL PRIVILEGES"
